...
#    Updated: 2021/04/29 18:09:03 by cisis            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSE_DIR	= parser/
PARSE_SRCS	= parser.c token.c lexer.c lexer_expandvar.c lexer_get_token.c check_symbol.c
...
EXEC_BUILTIN_SRCS	= export.c unset.c pwd.c env.c

...
#    Updated: 2021/05/04 14:06:43 by cisis            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSE_DIR	= parser/
PARSE_SRCS	= parser.c token.c lexer.c lexer_expandvar.c lexer_get_token.c check_symbol.c lexer_quotes.c lexer_check_grammar.c
